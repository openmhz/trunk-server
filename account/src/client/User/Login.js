  ...
  _onLoginSubmit(event) {
    ...
    if (this.props.nextLocation) {
        ...
        switch(this.props.nextLocation) {
          case "admin":
            success.nextLocation = admin_server;
          break;
          case "frontend":
            success.nextLocation = frontend_server;
          break;
        }
    }
        ...
        <Grid stackable >
          <Grid.Row>
            <Grid.Column width={9}>
                ...
                <Header size="small">
                  {site_name} makes it easy to share recordings from{" "}
                ...
                <p>
                  ...
                  - Luke{" "}
                  <a
                    href="mailto:{admin_email}?Subject={site_name}"
                    target="_top"
                  >
                    admin@email.com
                  </a>{" "}
