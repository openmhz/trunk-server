...
*/
var srcSchema = mongoose.Schema({ pos: Number, src: String, time: Number, tag: String, emergency: Number, signal_system: String });
var freqSchema = mongoose.Schema({ pos: Number, freq: Number, len: Number, error: Number, spikes: Number, time: Number});
