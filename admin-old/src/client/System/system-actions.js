...
export function updateSystem(data) {
  return dispatch => {
    ...
    return makeUserRequest("post", data, "/systems/" + data.shortName)
      .then(response => {
...
export function fetchErrors(shortName) {
  return (dispatch, getState) => {
    ...
    return axios
      .get(backend_server + "/" + shortName + "/systems")
      .then(response => {
        if (response.data) {
...
export function deleteSystem(shortName) {
  return dispatch => {
    ...
    return makeUserRequest("delete", null, "/systems/"+shortName)
      .then(response => {
        if (response.data.success) {
...
export function createSystem(data) {
  return dispatch => {
    ...
    return makeUserRequest("post", data, "/systems")
      .then(response => {
        if (response.data.success) {
